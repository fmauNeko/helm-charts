...
![Version: 0.3.13](https://img.shields.io/badge/Version-0.3.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.78.1](https://img.shields.io/badge/AppVersion-0.78.1-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v2.92.0"` | Dashboard image tag. NOTE: dashboard has its own release track, never falls back to chart appVersion. |
...
| patSeed.image.tag | string | `"8.22.0"` | PAT seed job image tag |
