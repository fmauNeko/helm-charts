...
![Version: 0.3.8](https://img.shields.io/badge/Version-0.3.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.74.7](https://img.shields.io/badge/AppVersion-0.74.7-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v2.90.5"` | Dashboard image tag. NOTE: dashboard has its own release track, never falls back to chart appVersion. |
