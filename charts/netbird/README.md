...
![Version: 0.3.10](https://img.shields.io/badge/Version-0.3.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.76.3](https://img.shields.io/badge/AppVersion-0.76.3-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v2.90.10"` | Dashboard image tag. NOTE: dashboard has its own release track, never falls back to chart appVersion. |
