...
![Version: 0.3.1](https://img.shields.io/badge/Version-0.3.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.73.2](https://img.shields.io/badge/AppVersion-0.73.2-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v2.80.0"` | Dashboard image tag. NOTE: dashboard has its own release track, never falls back to chart appVersion. |
